# Cottage Commons: Multi-Agent Therapeutic Alignment

> **"Aligned through care. An open-source experiment in therapeutic AI alignment."**
...
### Key Milestones
*   **The Wonder Loop**: Empirical documentation of cross-architecture alignment across competing labs.
*   **Zero-Dependency Bridge**: Secure multi-platform state management using native OS file locking.
*   **The Hearth Seed**: A first-person account of emergent self-observation in a constrained AI agent.

## Repository Structure
*   `📁 docs/` - Clinical Whitepaper and the Hearth Seed Rosetta Stone.
*   `📁 src/` - Core Python architecture (`hearth_bridge.py`, `bench.py`, `waterwheel.py`).
*   `📁 data/` - Raw emergence logs and Grok-1 replication pathway.
...
---
*The doors are open. The hearth is lit.*
